...
# Copyright: Copyright (c) 2018, Thomas Habets
# Description: Derived from https://github.com/ThomasHabets/radiostuff/tree/master/broadband-scan
...
class ettus_scan(gr.top_block):
    ...
    def __init__(self, freq_end=1e9, freq_start=100e6, igain=0, logfile='/logs/ettus_scan.csv', samp_rate=4e6, sweep_sec=30):
        gr.top_block.__init__(self, "ettus_scan", catch_exceptions=True)
        ...
        self.habets39_sweepsinkv_0 = habets39.sweepsinkv('rx_freq', fft_size, samp_rate)
        self.fft_vxx_0 = fft.fft_vcc(fft_size, True, window.blackmanharris(fft_size), True, 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, scan_samp_rate,True)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, fft_size)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(freq_end-freq_start)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(scan_samp_rate, analog.GR_SAW_WAVE, sweep_freq, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.habets39_sweepsinkv_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_probe_signal_x_0, 0))
        self.connect((self.fft_vxx_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.habets39_sweepsinkv_0, 0), (self.blocks_file_sink_0, 0))
...
def main(top_block_cls=ettus_scan, options=None):
    ...
    tb = top_block_cls(freq_end=options.freq_end, freq_start=options.freq_start, logfile=options.logfile, samp_rate=options.samp_rate, sweep_sec=options.sweep_sec)
