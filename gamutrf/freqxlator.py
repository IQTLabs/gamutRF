...
def main():
    ...
    parser.add_argument(
        '--center', dest='center', type=eng_float, default=eng_notation.num_to_str(float(-1e6)),
        help='Offset to new center frequency [default=%(default)r]')
    parser.add_argument(
        '--transitionbw', dest='transitionbw', type=eng_float, default=eng_notation.num_to_str(float(10e3)),
