...
class WindowsTestCase(unittest.TestCase):
    ...
    def test_verybusy1g1(self):
        ...
        self.assertIn((757.877504, 775.853632, -7.159875173989217, -24.08811337302156), signals, signals)
        self.assertIn((265.036816, 288.313568, -47.332711711197504, -23.3951832550739), signals, signals)
        self.assertIn((932.511936, 938.6112, -3.840928760465317, 7.672896900099766), signals, signals)
